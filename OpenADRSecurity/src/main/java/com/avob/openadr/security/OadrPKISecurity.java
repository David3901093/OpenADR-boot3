...
public class OadrPKISecurity {
    ...
    public static PrivateKey parsePrivateKey(FileReader fileReader) throws OadrSecurityException {
        ...
        try {
            ...
            System.out.println(readObject.getClass().getName());
            PrivateKeyInfo privateKeyInfo=null;
            switch (readObject) {
                case PEMKeyPair pemKeyPair -> privateKeyInfo = pemKeyPair.getPrivateKeyInfo();
                case PrivateKeyInfo keyInfo -> privateKeyInfo = keyInfo;
                ...
                case null, default -> throw new OadrSecurityException("private key file does not have good format");
            }
            return new JcaPEMKeyConverter().setProvider(new org.bouncycastle.jce.provider.BouncyCastleProvider()).getPrivateKey(privateKeyInfo);
        } catch (IOException e) {
            throw new OadrSecurityException(e);
        }
    }
    ...
    public static OadrUserX509Credential generateCredentials(KeyPair caKeyPair, X509Certificate caCert,
        ...
        try {
            ...
            KeyPair venCred = OadrPKISecurity.generateEccKeyPair();
            String csrAlgo = "SHA256withDSA";
