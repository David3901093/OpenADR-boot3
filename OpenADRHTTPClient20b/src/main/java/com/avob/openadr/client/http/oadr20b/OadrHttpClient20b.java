...
import com.avob.oadr.ObjectFactory;
...
public class OadrHttpClient20b {
	...
	private static final Log log = LogFactory.getLog(OadrHttpClient20b.class);
	 ...
	 * @throws URISyntaxException
	 */
	public <T, I > T post( I payload, String path, Class<T> responseKlass) throws Oadr20bException,
            Oadr20bHttpLayerException, Oadr20bXMLSignatureException, Oadr20bXMLSignatureValidationException {

        OadrPayload oadrPayload = Oadr20bFactory.createOadrPayload(null, payload);
        JAXBElement<OadrPayload> jaxbPayload = Oadr20bFactory.createJAXBOadrPayload(null,oadrPayload);
        OadrPayload responseOadrPayload  = this.post(null, path, null, jaxbPayload, OadrPayload.class);
		return Oadr20bFactory.extractSignedObject(responseOadrPayload, responseKlass);
	...
	public <O, I extends JAXBElement<?>> O post(String host, String path, HttpClientContext context, I payload,
		...
		try {
			...
			if (isXmlSignatureEnabled()) {
			...
			else if (entity.contains("oadrPayload")){
				ResponseUtils.setResString(entity);
				OadrPayload unmarshal = jaxbContext.unmarshal(entity, OadrPayload.class, validateXmlPayload);
				...
				ResponseUtils.setResString(entity);
				return jaxbContext.unmarshal(entity, responseKlass, validateXmlPayload);
			}
