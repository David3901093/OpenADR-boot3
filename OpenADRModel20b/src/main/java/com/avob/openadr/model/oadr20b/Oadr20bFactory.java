...
public class Oadr20bFactory {
	...
	public static OadrRegisterReportType createOadrRegisterReportType(String requestId, String venId) {
		...
		createOadrRegisterReportType.setReportRequestID(null);
	...
	private static final QName OADR_PAYLOAD_QNAME =
			new QName("http://openadr.org/oadr-2.0b/2012/07", "oadrPayload");


	public static JAXBElement<OadrPayload> createJAXBOadrPayload(String id, OadrPayload payload) {
		if (payload.getOadrSignedObject() != null) {
			payload.getOadrSignedObject().setId(id);
		}
		return new JAXBElement<>(OADR_PAYLOAD_QNAME, OadrPayload.class, null, payload);
	}


	public static <T> T extractSignedObject(OadrPayload payload, Class<T> clazz) {
		OadrSignedObject createOadrSignedObject = payload.getOadrSignedObject();
		Object res =null;
		if (createOadrSignedObject.getOadrDistributeEvent() != null) {
			res= createOadrSignedObject.getOadrDistributeEvent();
		} else if (createOadrSignedObject.getOadrCreatedEvent() != null) {
			res=  createOadrSignedObject.getOadrCreatedEvent();
		} else if (createOadrSignedObject.getOadrRequestEvent() != null) {
			res=  createOadrSignedObject.getOadrRequestEvent();
		} else if (createOadrSignedObject.getOadrResponse() != null) {
			res=  createOadrSignedObject.getOadrResponse();
		} else if (createOadrSignedObject.getOadrCancelOpt() != null) {
			res=  createOadrSignedObject.getOadrCancelOpt();
		} else if (createOadrSignedObject.getOadrCanceledOpt() != null) {
			res=  createOadrSignedObject.getOadrCanceledOpt();
		} else if (createOadrSignedObject.getOadrCreateOpt() != null) {
			res=  createOadrSignedObject.getOadrCreateOpt();
		} else if (createOadrSignedObject.getOadrCreatedOpt() != null) {
			res=  createOadrSignedObject.getOadrCreatedOpt();
		} else if (createOadrSignedObject.getOadrCancelReport() != null) {
			res= createOadrSignedObject.getOadrCancelReport();
		} else if (createOadrSignedObject.getOadrCanceledReport() != null) {
			res=  createOadrSignedObject.getOadrCanceledReport();
		} else if (createOadrSignedObject.getOadrCreateReport() != null) {
			res=  createOadrSignedObject.getOadrCreateReport();
		} else if (createOadrSignedObject.getOadrCreatedReport() != null) {
			res=  createOadrSignedObject.getOadrCreatedReport();
		} else if (createOadrSignedObject.getOadrRegisterReport() != null) {
			res=  createOadrSignedObject.getOadrRegisterReport();
		} else if (createOadrSignedObject.getOadrRegisteredReport() != null) {
			res=  createOadrSignedObject.getOadrRegisteredReport();
		} else if (createOadrSignedObject.getOadrUpdateReport() != null) {
			res=  createOadrSignedObject.getOadrUpdateReport();
		} else if (createOadrSignedObject.getOadrUpdatedReport() != null) {
			res=  createOadrSignedObject.getOadrUpdatedReport();
		} else if (createOadrSignedObject.getOadrCancelPartyRegistration() != null) {
			res=  createOadrSignedObject.getOadrCancelPartyRegistration();
		} else if (createOadrSignedObject.getOadrCanceledPartyRegistration() != null) {
			res=  createOadrSignedObject.getOadrCanceledPartyRegistration();
		} else if (createOadrSignedObject.getOadrCreatePartyRegistration() != null) {
			res=  createOadrSignedObject.getOadrCreatePartyRegistration();
		} else if (createOadrSignedObject.getOadrCreatedPartyRegistration() != null) {
			res=  createOadrSignedObject.getOadrCreatedPartyRegistration();
		} else if (createOadrSignedObject.getOadrRequestReregistration() != null) {
			res=  createOadrSignedObject.getOadrRequestReregistration();
		} else if (createOadrSignedObject.getOadrQueryRegistration() != null) {
			res=  createOadrSignedObject.getOadrQueryRegistration();
		} else if (createOadrSignedObject.getOadrPoll() != null) {
			res=  createOadrSignedObject.getOadrPoll();
		}

		return clazz.cast( res);
	}

	public static Object extractSignedObject(OadrPayload payload) {
		OadrSignedObject createOadrSignedObject = payload.getOadrSignedObject();
		Object res =null;
		if (createOadrSignedObject.getOadrDistributeEvent() != null) {
			res= createOadrSignedObject.getOadrDistributeEvent();
